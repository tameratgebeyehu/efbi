  ...
  return (
    <>
      ...
      <section className="section shell contact-grid">
        <div><SectionHeading eyebrow="Get in touch" title="Choose what works for you" description="Reach EFBI directly through any of these channels." /><div className="contact-cards"><a href="mailto:efbi.academy@gmail.com"><Icon name="mail" /><span><small>Email</small><strong>efbi.academy@gmail.com</strong></span><Icon name="external" /></a><a href="tel:+251725520306"><Icon name="phone" /><span><small>Phone</small><strong>+251 725 520 306</strong></span><Icon name="external" /></a><a href="https://t.me/EFBI_Academy" target="_blank" rel="noopener noreferrer"><Icon name="send" /><span><small>Telegram</small><strong>@EFBI_Academy</strong></span><Icon name="external" /></a><a href="https://t.me/+HhBFWhYdfChhYTlk" target="_blank" rel="noopener noreferrer"><Icon name="users" /><span><small>Community</small><strong>Join the student group</strong></span><Icon name="external" /></a><Link to="/privacy"><Icon name="shield" /><span><small>Learner help</small><strong>Privacy & support</strong></span><Icon name="arrow" /></Link></div></div>
