...
Phase 20 adds an administrator privacy queue with internal deadlines, hold-review indicators, deletion processing, and immutable Authentication-removal confirmation. Every transition is atomic and audited, certificate proof remains protected, and Firebase Authentication removal is a separate exact-UID console step. Reviewer-only accounts cannot open these controls. Appeals, file uploads, and public catalog release browsing remain locked.
