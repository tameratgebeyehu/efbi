  ...
  return <section className="review-workspace">
    ...
    <div className="review-layout">
      ...
      <aside className="assignment-panel"><p className="eyebrow">Review control</p>{!selected && <p>Choose a project to continue.</p>}
        ...
        <div className="review-boundary"><strong>Phase 17 boundary</strong><p>Originals, revisions, assignments, and results are permanent. Only one learner revision is allowed. Certificates and appeals remain disabled.</p></div>
      </aside>
    </div>
  </section>
}
