...
export default function EnrollmentManager({ user }: { user: User }) {
  ...
  return (
    <div className="enrollment-workspace">
      ...
      <aside className="enrollment-launch-warning"><strong>Public enrollment is not launch-ready.</strong><p>The safeguarding lead, backup contact, and external review are still open. Use Safety & incidents to see the current readiness checklist.</p></aside>
