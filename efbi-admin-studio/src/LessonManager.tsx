...
import type { LessonDraft, LessonFormValues, LessonStatus, PracticeQuestion } from './lessonModel'
...
export default function LessonManager({ user }: { user: User }) {
  ...
  useEffect(() => {
    ...
    return () => { active = false; stopCourses(); stopLessons() }
  }, [])
  ...
  return (
    <section className="course-workspace lesson-workspace">
      <header className="workspace-title">
        <div><p className="eyebrow">Phase 11 · Lessons and practice</p><h1>Lesson workspace</h1><p>Write lesson drafts, keep practice checks browser-only, and save every change with an audit trail.</p></div>
